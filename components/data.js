...
export const ServicesAllCategories = [
...
export const ServicesAllSubcategories = [
  "Сантехнические работы",
  "Электромонтажные работы",
  "потолки",
  "изготовление окон",
  ...
  "Реставрация и эмалировка ванн",
  "Перетяжка и ремонт мягкой мебели",
  "Изготовление ключей",
  "Алмазное сверление и резка",
  "Проектирование газовых сетей",
  "Вентиляция",
  "Стекольные услуги",
  "Проектирование зданий",
  "Ремонт и установка кодовых замков",
  ...
  "Электромонтажные работы — срочный выезд",
  "Сантехнические работы и отопление — аварийный выезд",
  "Маркизы",
  "Изготовление дверей из дерева",
  "Системы пожаротушения",
  "Лепнина и мозаики",
  "Изготовление витражей",
  "Установка карнизов",
  "Рольставни и секционные ворота",
